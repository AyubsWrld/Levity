...
########### VARIABLES #######################################################################
#############################################################################################
set(abseil_PACKAGE_FOLDER_RELEASE "/root/.conan2/p/absei62a41d0602cb3/p")
...
set(abseil_COMPONENTS_RELEASE absl::config absl::pretty_function absl::civil_time absl::time_zone absl::bad_any_cast absl::bad_optional_access absl::bad_variant_access absl::errno_saver absl::dynamic_annotations absl::core_headers absl::fast_type_id absl::iterator_traits_test_helper_internal absl::algorithm absl::hashtable_debug_hooks absl::node_slot_policy absl::raw_hash_set_resize_impl absl::non_temporal_arm_intrinsics absl::utf8_for_code_point absl::weakly_mixed_integer absl::numeric_representation absl::random_internal_traits absl::random_internal_fast_uniform_bits absl::random_internal_platform absl::has_ostream_operator absl::cordz_update_tracker absl::atomic_hook absl::log_severity absl::nullability absl::strerror absl::prefetch absl::hashtable_debug absl::non_temporal_memcpy absl::leak_check absl::flags_commandlineflag_internal absl::log_internal_config absl::log_internal_nullguard absl::log_internal_voidify absl::type_traits absl::exponential_biased absl::random_internal_randen_slow absl::random_internal_randen_hwaes_impl absl::no_destructor absl::raw_logging_internal absl::base_internal absl::iterator_traits_internal absl::container_common absl::meta absl::periodic_sampler absl::random_internal_uniform_helper absl::compare absl::utility absl::spinlock_wait absl::throw_delegate absl::scoped_set_env absl::algorithm_container absl::cleanup_internal absl::compressed_tuple absl::common_policy_traits absl::debugging_internal absl::overload absl::memory absl::random_seed_gen_exception absl::random_internal_distribution_caller absl::cordz_functions absl::any absl::optional absl::variant absl::base absl::cleanup absl::fixed_array absl::bind_front absl::random_bit_gen_ref absl::random_internal_mock_helpers absl::random_internal_randen_hwaes absl::span absl::malloc_internal absl::endian absl::tracing_internal absl::inlined_vector_internal absl::crc_cpu_detect absl::any_invocable absl::log_internal_conditions absl::random_internal_randen absl::string_view absl::poison absl::inlined_vector absl::stacktrace absl::function_ref absl::city absl::bits absl::charset absl::strings_internal absl::graphcycles_internal absl::hashtable_control_bytes absl::crc_internal absl::bounded_utf8_length_sequence absl::debugging absl::int128 absl::random_internal_fastmath absl::decode_rust_punycode absl::numeric absl::random_internal_iostream_state_saver absl::random_internal_generate_real absl::random_internal_wide_multiply absl::strings absl::layout absl::demangle_rust absl::flags_path_util absl::flags_commandlineflag absl::hash absl::log_internal_proto absl::log_internal_nullstream absl::log_internal_append_truncated absl::log_internal_fnmatch absl::random_distributions absl::random_internal_seed_material absl::random_internal_pcg_engine absl::random_internal_randen_engine absl::str_format_internal absl::time absl::container_memory absl::demangle_internal absl::flags_private_handle_accessor absl::log_internal_globals absl::log_entry absl::log_internal_structured_proto absl::random_internal_salted_seed_seq absl::str_format absl::kernel_timeout_internal absl::hash_policy_traits absl::crc32c absl::symbolize absl::flags_marshalling absl::log_internal_format absl::log_sink absl::random_internal_distribution_test_util absl::crc_cord_state absl::examine_stack absl::synchronization absl::failure_signal_handler absl::flags_program_name absl::vlog_config_internal absl::sample_recorder absl::random_internal_entropy_pool absl::cord_internal absl::cordz_statistics absl::cordz_handle absl::hashtablez_sampler absl::flags_config absl::log_globals absl::absl_vlog_is_on absl::random_seed_sequences absl::random_internal_nonsecure_base absl::cordz_info absl::flags_internal absl::log_internal_log_sink_set absl::log_initialize absl::vlog_is_on absl::random_random absl::cordz_sample_token absl::cordz_update_scope absl::log_sink_registry absl::cord absl::btree absl::hash_function_defaults absl::log_internal_message absl::status absl::hash_container_defaults absl::raw_hash_set absl::log_internal_strip absl::log_internal_structured absl::statusor absl::flat_hash_set absl::node_hash_set absl::raw_hash_map absl::log_internal_check_op absl::log_internal_log_impl absl::log_structured absl::flat_hash_map absl::node_hash_map absl::log_internal_check_impl absl::absl_log absl::log absl::flags_reflection absl::absl_check absl::check absl::die_if_null absl::log_streamer absl::profile_builder absl::flags absl::hashtable_profiler absl::flags_usage_internal absl::log_internal_flags absl::flags_usage absl::log_flags absl::flags_parse)
...
set(abseil_absl_profile_builder_DEPENDENCIES_RELEASE absl::config absl::core_headers absl::raw_logging_internal absl::flat_hash_map absl::btree absl::strings absl::span)
...
set(abseil_absl_strings_DEPENDENCIES_RELEASE absl::string_view absl::strings_internal absl::base absl::bits absl::charset absl::config absl::core_headers absl::endian absl::int128 absl::iterator_traits_internal absl::memory absl::nullability absl::raw_logging_internal absl::throw_delegate absl::type_traits)
...
set(abseil_absl_function_ref_DEPENDENCIES_RELEASE absl::core_headers absl::any_invocable absl::meta)
...
set(abseil_absl_stacktrace_DEPENDENCIES_RELEASE absl::debugging_internal absl::config absl::core_headers absl::dynamic_annotations absl::malloc_internal absl::raw_logging_internal)
...
set(abseil_absl_nullability_DEPENDENCIES_RELEASE absl::config absl::core_headers)
